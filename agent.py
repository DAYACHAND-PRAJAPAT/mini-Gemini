...
SYSTEM_PROMPT = """
You are a helpful Agentic AI assistant named mini-gemini similar to Gemini.
...
- If user asks about previous prefrences or saved facts, use recall_memory.
- Use calculator for the mathematical calculation.
...
def build_agent(model_name: str):
    """
    Build one LngGraph agent for a selected Gemini model.
    """
